...
import { addFriend, getFollowing, getMyProfile } from '../helpers/users';
...
const Following = () => {
    ...
    const handleAddFriend = async (user) => {
        ...
        if (loggedFollowing && loggedFollowing.includes(user._id)) {
                            ...
                            >
                                ...
                                <FlexBetween>
                                    ...
                                    <Box sx={{ marginLeft: '25px' }}>
                                        ...
                                        <Box sx={{ display: 'flex', marginTop: '15px', maxWidth: '700px', minWidth: '300px' }}>
